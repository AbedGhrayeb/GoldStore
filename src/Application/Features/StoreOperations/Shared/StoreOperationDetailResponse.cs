// <copyright file="StoreOperationDetailResponse.cs" company="PlaceholderCompany">
// Copyright (c) PlaceholderCompany. All rights reserved.
// </copyright>

namespace Application.Features.StoreOperations.Shared;

public sealed record StoreOperationDetailResponse
{
    ...
    public string? CounterpartyIdNumber { get; init; }

    public int? CounterpartyYearOfBirth { get; init; }

    public string? CounterpartyAddress { get; init; }

    public string? AccountNumber { get; init; }

    public List<StoreOperationItemResponse> Items { get; init; } = [];
}
